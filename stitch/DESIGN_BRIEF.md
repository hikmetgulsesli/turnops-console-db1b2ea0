...
- TurnOps Console turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser airport ground operations turn management app called TurnOps Console. It should coordinate aircraft turnaround tasks, gate readiness, fueling, catering, baggage, cleaning, crew handoff, delay risks, alerts, and shift supervisor views. Use Vite React Web App.
...
- Record Operations - TurnOps Console
- Record Editor - TurnOps Console
- Status Board - TurnOps Console
- Insights - TurnOps Console

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - TurnOps Console
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - TurnOps Console
...
SCREEN_SPEC_3:
- exact_screen_title: Status Board - TurnOps Console
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - TurnOps Console
